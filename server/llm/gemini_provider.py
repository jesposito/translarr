...
Google's Gemini API supports OpenAI-compatible chat completions via
``https://generativelanguage.googleapis.com/v1beta/openai/``. We use
the OpenAI SDK with a custom base_url.

Pricing (2026-05): Gemini 2.5 Flash is $0.15/M input, $0.60/M output.
Gemini 2.5 Pro is $1.25/M input, $10.00/M output.
"""
